...
<div class="row">
	...
	<div class="hit-device">
		...
		<h3>Scan your QR Code to <br> Begin Activation</h3>
			<button type="button" class="hi-edit-cvr-btn">Begin  Activation</button>
	...
	<button type="button" class="hi-edit-cvr-btn">Get Device</button>
	</div></div></div>
	</div></div>
</div>
...
<input type="hidden" value="<?php echo $user;?>" id="user" readonly class="form-control" >
	...
	<center>
		<button type="button" class="hi-edit-cvr-btn" data-toggle="modal" data-target="#BeginScan">Hooray</button>
		<button type="button" class="hi-edit-cvr-btn" data-toggle="modal" data-target="#BeginActivation">Oops</button>
	</center>
...
<div class="pb-4 hit-cl-4">
	<div class="hit-devices">
		<img class="img-fluid" src="<?php echo base_url(); ?>assets/img/users/hi-card-sample.png"/>
	</div>
	<div>
