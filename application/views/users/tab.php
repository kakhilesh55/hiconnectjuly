<?php
$connect = mysqli_connect("localhost", "u675218633_hiconnectdemo", "Kdc5ea4k$", "u675218633_hiconnectdemo");
...
while($row = mysqli_fetch_array($tab_result))
{
 ...
 $product_query = "SELECT * FROM pd WHERE category_id = '".$row["category_id"]."'";
