            ...
            <div class="card">
                 <div class="card-header d-flex" style="justify-content: space-between;">
                    <h4>Product Details</h4>
                      <a href="#" id="<?php echo $id;?>" data-bs-toggle="modal" data-bs-target="#exampleModal22" class="btn btn-primary update" title="Edit">Add Product Details</i></a> 
                  </div>
                   <?php 
                         ...
                         if(isset($products) && is_array($products) && count($products)): $slno=1; 
                          ...
                          <?php } ?></td>
                           ...
                           <td><?php echo $product['description'];?></td>
                            <td><a href="#" id="<?php echo $product['product_id'];?>" data-bs-toggle="modal" data-bs-target="#exampleModal223" class="btn btn-primary update" title="Edit"><i class="fa fa-edit"></i></a> 
...
<form name="products" method="post" action="<?= base_url('education/update_pdt') ?>" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="name">Name</label>
                                                <input type="hidden" class="form-control" id="pdtid" name="product_id" value="<?php echo isset($product->product_name)?$product->product_name:'';?>" required="">

                        <input type="text" class="form-control" id="pdt_name" name="product_name" value="<?php echo isset($product->product_name)?$product->product_name:'';?>" required="">
                      </div>
                      <div class="form-group col-md-12">
                        <label for="currency">Currency</label>
                        <select id="currency" name="currency"  class="form-control">
                    ...
                    <div class="form-group col-md-12">
                        <label for="price">Price</label>
                        <input type="text" class="form-control" id="pdt_price" name="price" value="<?php echo isset($product->price)?$product->price:'';?>">
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-12">
                    ...
                    <div class="form-row">
                       <div class="form-group col-md-12">
                        <label for="desc">Description</label>
                        <textarea class="form-control" id="pdt_description" name="description" maxlength="250"><?php echo isset($product->description)?$product->description:'';?></textarea>
                      </div>
                    </div>
                    </div>
                  <div class="card-footer">
...
<script>
      $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url() ?>Education/view_products/",  
                method:"POST",  
                ...
                {  
                     ...
                     $('#pdt_name').val(data.product_name);  
           $('#pdtid').val(data.product_id);  
                   $('#pdt_description').val(data.description); 
