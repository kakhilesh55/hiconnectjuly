          ...
          <div class="row ">
            ...
            <div class="card">
                  ...
                  <form name="enquiry_form" method="post" action="">
                    ...
                    <button  name="btnExport" class="pull-right btn btn-primary btn-xs" onclick="generatexls1()" ><i class="fa fa-file-excel-o"></i> Export data to Excel</button>
                          ...
                          <tr>
                            ...
                            <td><?php if($user['order_status']==0)
                             echo 'Order Received';
                              ...
                              echo 'Failed';?></td>
                            <td>
                              <a href="<?php echo site_url('manage_orders/process_orders/'.$user['id'])?>" class="btn btn-icon icon-left btn-primary" title="Edit"><i class="far fa-edit"></i></a>
