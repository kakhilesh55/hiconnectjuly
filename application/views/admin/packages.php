        ...
        <section class="section">
          <div class="row ">
            ...
            <div class="card">
                  ...
                  <?php }  ?>
                  <form name="package" method="post" action="<?= base_url('package/packages') ?>">
                  <div class="card-body">
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <label for="package">Package Name</label>
                        <input type="text" class="form-control" id="package" name="package" value="<?php echo isset($package->package)?$package->package:'';?>" required=""> 
                      </div>
                      <div class="form-group col-md-4">
                        <label for="currency">Currency</label>
                        <select id="currency" name="currency" class="form-control">
                            <option>Select currency</option>
                            <option value="AFN" <?php  if(isset($package->currency)) echo ($package->currency=='AFN')?'selected':'';?>>Afghan Afghani - ؋</option>
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="regular_price" name="regular_price" value="<?php echo isset($package->regular_price)?$package->regular_price:'';?>" required=""> 
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <label for="sale_price">Sale Price</label>
                        <input type="text" class="form-control" id="sale_price" name="sale_price" value="<?php echo isset($package->sale_price)?$package->sale_price:'';?>" required=""> 
                      </div>

                      <div class="form-group col-md-8">
                        <label for="description">Package Description</label>
                        <textarea class="form-control" id="description" name="description" required><?php echo isset($package->description)?$package->description:'';?></textarea> 
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                           <?php 
                         if(isset($packages) && is_array($packages) && count($packages)): $slno=1; 
                          ...
                          <tr>
                           ...
                           <td><?php echo $package['regular_price'];?></td>
                           <td><?php echo $package['sale_price'];?></td>
                           <td><?php echo nl2br($package['description']);?></td>
                            <td><a href="<?php echo site_url('package/packages/'.$package['package_id'])?>" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a> 
                             <a href="<?php echo site_url('package/delete_package/'.$package['package_id'])?>" class="btn btn-icon btn-danger" title="Delete"><i class="fa fa-times"></i></a></td>
                          </tr>
                           <?php  
                          $slno++;
                        endforeach; 
