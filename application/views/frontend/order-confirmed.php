...
<div class="col-12">
          <div class="card text-center border-0">
            <div class="card-body hi-sucess-payee">
              <img class="hi-sucess-pay" src="http://localhost/hiconnect/css1/images/success.svg" alt="How it image">
			  <h4>Your Payment is Successful!</h4>
			  <p class="card-text">Activate your Hi Connect product to your profile when it arrives.</p>
              <p class="card-text">Order ID: order_173526849</p>
			  <p class="card-text">Payment Recieved: 9745</p>
			  <a href="/how-it-works.php" class="hi-track">Track Your Order</a><br>
              <a href="/how-it-works.php" class="btn-red btn-hi sli-btn pay-btnz">Go To Dashboard</a>
            </div>
          </div>
        </div>
      </div>
