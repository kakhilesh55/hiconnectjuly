...
<body>
  ...
  <!-- ======= Header ======= -->
<section class="hi-hundred-h">
<div class="container col-xl-9 position-relative">
 <header id="header" class="d-flex align-items-center onb-header p-0 hi-hdr-ab" style="padding-top:32px !important; ">
    <div class="d-flex align-items-center">
      <a href="https://hiconnect.co.in/" class="hic-logo"><img src="https://hiconnect.co.in/css1/images/logo-tm-hiconnect.png" alt=""></a>
</div></header>
<section id="hi-pay-error" class="d-flex align-items-center">
    <div class="aos-init aos-animate hi-hundred-w" data-aos="fade-up" data-aos-delay="100">
      <div class="row">
<div class="col-12">
          <div class="card text-center border-0">
            <div class="card-body hi-error">
			  <h4>Oops! Something went wrong</h4>
			  <div class="d-flex justify-content-center">
              <a href="/contact.php" class="btn-white btn-hi sli-btn pay-btnz me-3">Report</a>
              <a href="/how-it-works.php" class="btn-red btn-hi sli-btn pay-btnz">Back</a>
			  </div>
            </div>
          </div>
        </div>
