      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        <div class="form-inline">
          <ul class="navbar-nav wi-hun">
            ...
            <li class="wi-hun">
                <div class="cardlink">
                   <input type="text" class="form-control" value="<?= base_url()."home.php/".$this->session->userdata('username'); ?>" id="card_link" disabled>
        ...
        <ul class="navbar-nav navbar-right">
                <li class="dropdown"><a href="<?php echo base_url(); ?>enquiries" 
