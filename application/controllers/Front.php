...
class Front extends CI_Controller
{
   public function __construct()
        ...
        public function protection()
    {
       ...
       // $data['products'] = $this->cart_model->get_all();
        $this->load->view('frontend/protection',$data);
        $this->load->view('frontend/footer');
        ...
        public function refund()
    {
       ...
       // $data['products'] = $this->cart_model->get_all();
        $this->load->view('frontend/refund',$data);
        $this->load->view('frontend/footer');
        ...
        public function return()
    {
       ...
       // $data['products'] = $this->cart_model->get_all();
        $this->load->view('frontend/return',$data);
        $this->load->view('frontend/footer');
        ...
        public function affilate()
    {
       ...
       // $data['products'] = $this->cart_model->get_all();
        $this->load->view('frontend/affilate',$data);
        $this->load->view('frontend/footer');
        ...
        public function reseller()
    {
       ...
       // $data['products'] = $this->cart_model->get_all();
        $this->load->view('frontend/reseller',$data);
        $this->load->view('frontend/footer');
        ...
        public function wrk()
    {
       ...
       // $data['products'] = $this->cart_model->get_all();
        $this->load->view('frontend/wrk',$data);
        $this->load->view('frontend/footer');
    ...
    public function how()
    {
        ...
        $this->load->view('frontend/header');
        $this->load->view('frontend/howtowork');
    ...
    public function tutorial()
    {
        ...
        $this->load->view('frontend/header');
        $this->load->view('frontend/tutorial');
        $this->load->view('frontend/footer');
