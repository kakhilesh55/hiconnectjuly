...
<head>
  ...
  <!-- Favicons -->
  <link href="erp/assets/img/HiConnect-Icon.svg" rel="icon">
...
<link href="t3/css/style.css" rel="stylesheet">
<link href="t3/css/tooltip.css" rel="stylesheet">
                     ...
                     <div class="col-8 d-flex justify-content-start">
                        <div class="align-self-center ps-2">
                           <div class="webly-wallet">
                              <!--<img src="css/images/Google pay.png" alt="">-->
            ...
            { ?>				  
                  ...
                  <div class="row webly-payments">
                     <div class="col-8 d-flex justify-content-start">
                        <div class="align-self-center ps-2">
                           <div class="webly-wallet">
                              <img src="css/images/Bank AC.png" alt="">
                              <p>Bank/UPI Id</p>
                           </div>
                        </div>
                     </div>
...
<div class="snippet1"><input class="dzp-none" type="text" value="Copy Code Here"></div>
    <p class="mt-2">Copy</p>
  </div>
  <div class="user-share pt-3">
    <a href="sms:+918750133317?body=ctvgybhnjkbhjn yghuihjiu">
    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-message" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
<div class="text-center d-flex justify-content-around pb-2">
  <div class="user-share pt-3">
    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail-opened" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <polyline points="3 9 12 15 21 9 12 3 3 9" />
  <path d="M21 9v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10" />
  <line x1="3" y1="19" x2="9" y2="13" />
      ...
      <div class="modal fade" id="whatsappshare" tabindex="-1">
         <div class="modal-dialog">
            <div class="modal-content modalsz p-4">
               ...
               <form action="forms/contact.php" method="post" role="form" class="php-email-form pt-0">
                  <div class="row">
                     <label class="mt-3 pb-1" for="Name">Whatsapp Number:</label>
                     <div class="form-group pb-3 d-flex justify-content-between">
                        <div class="in-number">
                           <input type="text" name="Whatsapp" value="+91" class="form-control rounded-0 bord-2" id="Whatsapp" placeholder="Whatsapp Number" required="">
                        </div>
                        <div style="text-align: right;" class="in-send ps-2"><button class="sh-whats" type="submit"></button></div>
                     </div>
                  </div>
               </form>
            </div>
...
<script src="t3/js/copy/clipboard.min.js"></script>
<script src="t3/js/copy/demos.js"></script>
<!--<script src="js/copy/snippets.js"></script>-->
<script src="t3/js/copy/snippet-full.js"></script>
<script src="t3/js/copy/tooltips.js"></script>
